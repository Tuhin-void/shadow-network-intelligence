"""
Transaction Generator - Financial transaction generation
"""
from typing import Optional, List
import random
from datetime import datetime, timedelta

from ..schemas.transaction import TransactionSchema, TransactionType, TransactionStatus
...
class TransactionGenerator:
    ...
    DESCRIPTIONS = [
        ...
        "Wire transfer", "ACH payment", "Business expense", "Consulting fee",
        "Investment", "Loan repayment", "Royalty payment", "Dividend distribution",
        "Rent payment", "Vendor payment", "Payroll", "Contractor payment",
    ]

    SUSPICIOUS_DESCRIPTIONS = [
        "Unusual activity", "Round amount transfer", "Quick round trip",
        "Layered transfer", "Structuring activity", "Offshore routing",
    ]
    ...
    def generate(
        ...
        tx_type = r.choice([
            TransactionType.WIRE, TransactionType.ACH,
            TransactionType.CASH, TransactionType.CHECK,
        ])
